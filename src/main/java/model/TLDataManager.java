...
public class TLDataManager {
    ...
    public static TLDataManager sharedInstance;

    public final String administratorName = Configuration.administratorName;
    public final String administratorPassword = Configuration.administratorPassword;
    ...
    public boolean importBooks(String bookName, String publisher, String author,
    ...
    public boolean selectBook(String bookName, String[] resultContainer) {
    ...
    public boolean searchNameForBook(String[][] dataContainer, String bookName) {
        String sql = "SELECT * FROM Book WHERE book_name LIKE '%" + trimStringToSQL(bookName) + "%'";
        System.out.println(sql);
        try {
            statement = connection.createStatement();
    ...
    public boolean searchAuthorForBook(String[][] dataContainer, String author) {
    ...
    public boolean searchYearForBook(String[][] dataContainer, String begin, String end) {
    ...
    public boolean checkForBookAmount(String bookName) {
    ...
    public int userBorrowRecord(String readerName) {
        int reader_id = 0;
    ...
    public boolean dropReader(String readerName) {
